...
suspend fun Application.module() {
    ...
    val ioSchedulerScope = CoroutineScope(SupervisorJob() + Dispatchers.IO + CoroutineName("priceAgent") + exceptionHandler)
    ...
    val cpuSchedulerScope = CoroutineScope(SupervisorJob() + Dispatchers.Default + CoroutineName("strategyAgent") + exceptionHandler)
