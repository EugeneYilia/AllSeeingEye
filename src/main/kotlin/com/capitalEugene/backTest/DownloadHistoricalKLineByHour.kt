...
object DownloadHistoricalKLineByHour {
                ...
                for (year in years) {
                    ...
                    try {
                        ...
                        if (data.isNotEmpty()) {
                            ...
                            println(
                                "✅ 完成 $symbol $interval $year, 记录数: ${data.size}, 耗时: ${
                                    "%.2f".format(
                                        duration
                                    )
                                }秒"
    ...
    suspend fun downloadYearKlines(
        ...
        println(
            ...
            } 至 ${LocalDateTime.ofInstant(Instant.ofEpochMilli(endMs), ZoneOffset.UTC)}"
        )
        ...
        while (afterRaw != null) {
            ...
            val url =
                "https://www.okx.com/api/v5/market/history-candles?instId=$symbol&bar=$interval&limit=$limit&after=$afterParam"
